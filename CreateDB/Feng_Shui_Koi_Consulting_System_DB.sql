...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'CN2301C_FengShuiKoiConsulting_DB')
BEGIN
    ALTER DATABASE [CN2301C_FengShuiKoiConsulting_DB] SET OFFLINE WITH ROLLBACK IMMEDIATE;
    ALTER DATABASE [CN2301C_FengShuiKoiConsulting_DB] SET ONLINE;
    DROP DATABASE [CN2301C_FengShuiKoiConsulting_DB]
END

GO

CREATE DATABASE CN2301C_FengShuiKoiConsulting_DB;
GO

USE CN2301C_FengShuiKoiConsulting_DB
GO
...
GO
INSERT [dbo].[Account] ([UserID], [Password], [Role], [Email], [Status]) VALUES (N'trungtai', N'123', N'Member', N'taint1272@gmail.com', N'Active')
INSERT [dbo].[Account] ([UserID], [Password], [Role], [Email], [Status]) VALUES (N'tai', N'123', N'Admin', N'nguyentai2292005@gmail.com', N'Active')
INSERT [dbo].[Account] ([UserID], [Password], [Role], [Email], [Status]) VALUES (N'tuong', N'123', N'Member', N'nguyenvantuong29102005@gmail.com', N'Active')
INSERT [dbo].[Account] ([UserID], [Password], [Role], [Email], [Status]) VALUES (N'thanh', N'123', N'Member', N'dpvthanh1711@gmail.com', N'Active')
INSERT [dbo].[Account] ([UserID], [Password], [Role], [Email], [Status]) VALUES (N'huy', N'123', N'Member', N'vohuy3899@gmail.com', N'Active')
...
</section>', N'tuong', N'Thổ', N'Approved')
...
<p class="MsoNormal" style="text-align: center;">&nbsp;</p>', N'huy', N'Mộc', N'Approved')
...
<p style="text-align: center;">Công ty Koi Việt<br>Tel: 0933.549.011<br>E-mail: koiviet@gmail.com<br>Website: https://www.koiviet.com</p>', N'huy', N'Thổ', N'Approved')
...
<p style="text-align: center;">Liên hệ ngay để sở hữu những chú cá Koi đẳng cấp, mang lại may mắn và tài lộc cho gia đình bạn!</p>', N'huy', N'Thủy', N'Approved')
...
<p style="text-align: center;">Địa chỉ: 123 Đường Bình An, Quận Thủ Đức, TP.HCM<br>Tel: 0933.549.011<br>E-mail: cafekoi@gmail.com<br>Website: https://www.cafekoi.com</p>', N'thanh', N'Thủy', N'Approved')
...
#YokoKoiFarm #CaKoi #KoiNhat #HoKoi #PhongThuy" data-section-index="38">#YokoKoiFarm #CaKoi #KoiNhat #HoKoi #PhongThuy</p>', N'huy', N'Thủy', N'Approved')
...
<li>Cung cấp dịch vụ bảo hành sức khỏe cá trong 1 tháng</li> 
<li>Tư vấn miễn phí về thiết kế hồ cá và cách chăm sóc</li> 
<li>Vận ctrungtaiển toàn quốc, đảm bảo an toàn tuyệt đối cho cá Koi</li> 
</ul> 
<p style="text-align: center;">Liên hệ ngay để sở hữu những chú cá Koi đẳng cấp, mang lại may mắn và tài lộc cho gia đình bạn!</p>', N'trungtai', N'Mộc', N'Approved')
...
<p dir="ltr"><img style="display: block; margin-left: auto; margin-right: auto;" src="https://hatalandscape.com/public/uploads/files/thac-nuoc-mini-trong-san-vuon-515643.jpg" alt="Lưu &yacute; khi trang tr&iacute; hồ c&aacute;"></p>', N'tuong', N'Mộc', N'Approved')
...
<p style="text-align: center;">Liên hệ ngay để sở hữu những chú cá Koi tuyệt đẹp, mang lại tài lộc và may mắn!</p>', N'huy', N'Thổ', N'Approved')
...
</div>', N'trungtai', N'Hỏa', N'Approved')
GO
...
GO
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB001', N'vị trí thoáng,cá nhiều,cà phê sữa ngon,có khu vui chơi dành cho trẻ e.', N'AD081', 5, N'tai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB002', N'chú bảo vệ rất nhiệt tình ', N'AD081', 5, N'trungtai')
...
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB005', N'Cá KOI siêu to khổng lồ, ngắm rất thích. Nhưng chỗ này không phải quán cafe, mà chuyên trưng bày và bán cá KOI là chủ yếu. Khách có thể vào nghỉ ngơi uống cafe xem cá nhưng thức uống chỉ có cafe, nước cam và chanh dây.', N'AD363', 5, N'trungtai')
...
', N'AD363', 5, N'huy')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB007', N'Trang trí hồ cá rất đẹp, shop bán hàng uy tín, anh chủ dễ thương nhiệt tình 🥰🥰 …', N'AD820', 5, N'trungtai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB008', N'Dịch vụ rất tốt , làm việc sạch sẽ gọn gàng . Nhân viên thân thiện . Lần sau cần đến sẽ tiếp tục sử dụng dịch vụ bên mình . Cảm thấy hài lòng .', N'AD820', 5, N'trungtai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB009', N'một sự hợp tác tuyệt vời ', N'AD126', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB010', N'cá koi phong phú nhiều màu sắc, nhân viên nhiệt tình.', N'AD126', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB011', N'chất lượng tốt ', N'AD997', 5, N'tai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB012', N'cá koi phong phú, nhiều màu sắc rực rỡ.', N'AD997', 5, N'tuong')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB013', N'quy trình làm việc chuyên nghiệp', N'AD483', 5, N'huy')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB014', N' Chương trình khuyến mãi hấp dẫn, giảm giá 20% cho cám cá Koi. Đây là cơ hội tốt cho những ai nuôi cá Koi, giúp tiết kiệm chi phí.', N'AD759', 5, N'trungtai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB015', N'loại cám dành cho cá koi chất lượng cao, giá thành hợp lí', N'AD483', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB016', N'Dịch vụ thiết kế và thi công hồ cá Koi mini rất phù hợp cho những không gian nhỏ. Thông tin chi tiết về dịch vụ sẽ giúp khách hàng dễ dàng lựa chọn.', N'AD483', 5, N'trungtai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB017', N'hình dáng của hồ khi nhìn từ bên ngoài rất đẹp ', N'AD419', 5, N'tuong')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB018', N'Cung cấp cá Koi Nhật Bản chất lượng, phù hợp cho những ai đang tìm kiếm cá Koi đẹp và khỏe mạnh.', N'AD065', 5, N'tai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB019', N'Cung cấp cá Koi chất lượng cao không chỉ thu hút những người nuôi cá mà còn là cơ hội cho những nhà đầu tư trong lĩnh vực cá cảnh.', N'AD762', 5, N'huy')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB020', N'Dịch vụ thiết kế hồ cá Koi tại Sơn La mở rộng cơ hội cho những người yêu thích cá Koi ở khu vực này. Cần thêm thông tin về chất lượng dịch vụ.', N'AD083', 5, N'huy')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB021', N'Dịch vụ này không chỉ mang lại giá trị thẩm mỹ mà còn tạo ra một môi trường sống lý tưởng cho cá Koi, giúp chúng phát triển khỏe mạnh.', N'AD551', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB022', N'Cung cấp cá Koi Nhật Bản chất lượng, phù hợp cho những ai đang tìm kiếm cá Koi đẹp và khỏe mạnh.', N'AD551', 5, N'tuong')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB023', N'Cung cấp cá Koi chất lượng cao không chỉ thu hút những người nuôi cá mà còn là cơ hội cho những nhà đầu tư trong lĩnh vực cá cảnh.', N'AD419', 5, N'tuong')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB024', N'Trang trại này có thể tổ chức các sự kiện hoặc hội thảo về chăm sóc cá Koi, giúp người nuôi có thêm kiến thức và kinh nghiệm.', N'AD065', 5, N'tai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB025', N'Trang trại Koi hàng đầu, có thể cung cấp nhiều loại cá Koi khác nhau. Thông tin chi tiết sẽ giúp khách hàng hiểu rõ hơn về sản phẩm.', N'AD065', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB026', N'Một địa điểm thú vị để thư giãn và thưởng thức cà phê trong không gian có cá Koi. Rất thích hợp cho những ai yêu thích thiên nhiên.', N'AD762', 5, N'trungtai')
...
', N'AD083', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB029', N'Trang trại cá Koi lớn, cung cấp nhiều loại cá Koi cho khách hàng. Đây là điểm đến lý tưởng cho những người yêu thích cá Koi tại Hà Nội.', N'AD083', 5, N'trungtai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB030', N' Không gian thư giãn với cá Koi, rất thích hợp cho những buổi gặp gỡ bạn bè hoặc gia đình. Cần thêm thông tin về menu và dịch vụ.', N'AD004', 5, N'tuong')
...
', N'AD878', 5, N'huy')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB032', N' Sử dụng đá tự nhiên, cây thủy sinh và các yếu tố tự nhiên khác để tạo ra một môi trường sống gần gũi với thiên nhiên. Cây cối không chỉ làm đẹp mà còn giúp cải thiện chất lượng nước.', N'AD878', 5, N'tuong')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB033', N' Ánh sáng cũng rất quan trọng; sử dụng đèn LED dưới nước có thể tạo ra hiệu ứng lung linh, làm nổi bật vẻ đẹp của cá và cảnh quan xung quanh.', N'AD551', 5, N'trungtai')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB034', N'Quán cafe koi là một không gian lý tưởng để thư giãn và thưởng thức cà phê trong khi ngắm nhìn những chú cá koi bơi lội. Để tạo ra một quán cafe koi hấp dẫn, bạn nên xem xét các yếu tố ', N'AD551', 5, N'thanh')
INSERT [dbo].[Feedback] ([FbID], [Description], [AdID], [Rate], [UserID]) VALUES (N'FB035', N'Không gian quán nên được thiết kế mở, với nhiều cửa sổ để khách hàng có thể dễ dàng nhìn thấy hồ cá. Sử dụng các vật liệu tự nhiên như gỗ và đá để tạo cảm giác gần gũi và ấm cúng.', N'AD551', 5, N'huy')
GO
...
GO
INSERT [dbo].[Member] ([Name], [Birthday], [UserID]) VALUES (N'Nguyễn Tài', CAST(N'2005-08-19' AS Date), N'trungtai')
INSERT [dbo].[Member] ([Name], [Birthday], [UserID]) VALUES (N'Nguyễn Trung Tài', CAST(N'2005-08-19' AS Date), N'tai')
INSERT [dbo].[Member] ([Name], [Birthday], [UserID]) VALUES (N'Nguyễn Văn Tường', CAST(N'2005-07-22' AS Date), N'tuong')
INSERT [dbo].[Member] ([Name], [Birthday], [UserID]) VALUES (N'Nguyễn Văn Thành', CAST(N'2005-06-17' AS Date), N'thanh')
INSERT [dbo].[Member] ([Name], [Birthday], [UserID]) VALUES (N'Võ Anh Huy', CAST(N'2005-05-15' AS Date), N'huy')
...
USE [master]
GO
ALTER DATABASE [CN2301C_FengShuiKoiConsulting_DB] SET  READ_WRITE 
GO
